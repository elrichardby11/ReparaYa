    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technician_rut', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.technicianservice')),
                ('id_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='requests.request')),
            ],
        ),
    ]
