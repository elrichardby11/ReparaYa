"""
Django settings for reparaya project.
...
SECRET_KEY = "django-insecure-g(+=r+3-os_t&ud%_o#o%ktbq$jp$!#ya%v_cv0iz59r-+f6l)"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.users.context_processors.user_type",
            ],
        },
    },
]

WSGI_APPLICATION = "reparaya.wsgi.application"
